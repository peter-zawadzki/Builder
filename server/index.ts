...
import { mountainConnections } from "./routes/mountainConnections";
import { resourceFiles } from "./routes/resourceFiles";
...
import { knowledgeDocuments } from "./routes/knowledgeDocuments";
...
app.use("/api/mountain-connections/*", requireAuth);
app.use("/api/resource-files/*", requireAuth);
...
app.use("/api/knowledge-documents/*", requireAuth);
...
app.route("/api/mountain-connections", mountainConnections);
app.route("/api/resource-files", resourceFiles);
